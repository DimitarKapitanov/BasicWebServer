...
namespace BasicWebServer.Server.HTTP
{
    public class Request
    {
        ...
        public static Request Parse(string request)
        {
            ...
            var session = GetSession((CookieCollection)cookies);
            ...
            return new Request
            {
                ...
                Url = url,
                Headers = headers,
                Cookies = (CookieCollection)cookies,
                Body = body,
        ...
        private static object GetSession(CookieCollection cookies)
        {
        ...
        {
            var headertCollection = new HeaderCollection();
            ...
            foreach (var headerLine in headerLines)
            {
                ...
                headertCollection.Add(headerName, headerValue);
            }
        ...
        private static object ParseMethod(string method)
        {
            ...
            catch (Exception)
            {
                ...
                return new InvalidOperationException($"Method {method} is not supported");
            }
        }
    }
}
